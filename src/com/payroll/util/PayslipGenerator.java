...
/**
 * Generates individual payslip text files for each employee.
 * File is saved to payslips/EMP001_payslip.txt
 * Demonstrates: File writing with FileWriter.
 */
public class PayslipGenerator {
    ...
    /**
     * Writes a formatted payslip to file for the given employee.
     *
     * @param employee    The employee
     * @param grossSalary Calculated gross salary
     * @param deductions  Total deductions
     * @param netSalary   Final net salary
     */
    public static synchronized void generatePayslip(Employee employee,
                                                     double grossSalary,
                                                     double deductions,
                                                     double netSalary) {
